...
if __name__ == "__main__":
    ...
    parser.add_argument('--table_name', type=str, default='myntra_v3', help='Name of the table')
    parser.add_argument('--search_query', type=str, default='kurta', help='Search query')
    ...
    parser.add_argument('--limit_default', type=int, default=6, help='Default limit for number of results')
